...
namespace MailService.API.Controllers
{
    ...
    public class MailController : Controller
    {
        ...
        public async Task<IActionResult> Show()
        {
            ...
            {
                SentMessage sentMessage = await GetSentMessageById(message.Id);
        ...
        {
            SentMessage sentMessage = await GetSentMessageById(messageId);
        ...
        /// <returns>Information about sent message</returns>
        private async Task<SentMessage> GetSentMessageById(int messageId)
        {
